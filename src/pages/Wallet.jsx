...
function Wallet() {
    ...
    useEffect(()=>{
        const fetchData = async ()=>{
            const {data} = await axios.get('http://ec2-52-65-120-170.ap-southeast-2.compute.amazonaws.com:3000/wallet', {
                params:{
                    userId: user.user.id
                },
                headers: {
            ...
            setWallet(data);
            const asset = await axios.get('http://ec2-52-65-120-170.ap-southeast-2.compute.amazonaws.com:3000/asset',{
                params:{
                    userId: user.user.id
                },
                headers: {
